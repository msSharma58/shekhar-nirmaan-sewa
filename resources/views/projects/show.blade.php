      ...
      <div class="projects-grid">
        @foreach($relatedProjects as $relatedProject)
          <a class="project-card" href="{{ route('projects.show', $relatedProject) }}">
            <img
              src="{{ $relatedProject->image_url ? (Str::startsWith($relatedProject->image_url, 'http') ? $relatedProject->image_url : Storage::url($relatedProject->image_url)) : 'https://via.placeholder.com/1200x800?text=Project' }}"
